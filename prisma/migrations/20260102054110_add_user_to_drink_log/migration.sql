...
INSERT INTO "new_DrinkLog" ("bartenderId", "customerName", "drinkId", "eventId", "id", "status", "timestamp") SELECT "bartenderId", "customerName", "drinkId", "eventId", "id", "status", "timestamp" FROM "DrinkLog";
DROP TABLE "DrinkLog";
